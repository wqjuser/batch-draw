...
default_prompt = '(8k, best quality, masterpiece:1.2), best quality, official art, highres, ' \
                 ...
                 'highly detailed, absurdres, 8k resolution,exquisite facial features, ' \
                 'huge filesize,ultra-detailed'
...
action_prompts = ['smelling', 'princess carry', 'hug', 'back-to-back', 'peace symbol', 'adjusting_thighhigh',
                  'grabbing', 'fighting_stance', 'walking', 'running', 'straddling', 'jump', 'fly', 'against wall',
                  'lie', 'hug from behind', 'walk a dog', 'skirt lift', 'half body under water', 'horse riding',
                  'selfie', 'standing split', 'salute, pray', 'doing a meditation', 'stretch', 'gill support',
                  'holding hands', 'hand_on_hip', 'hands_on_hips', 'waving', 'kissing forehead', 'hair scrunchie',
                  'hair_pull', 'grabbing hair', 'middle_finger', 'kissing cheek', 'bent over', 'tiptoe kiss',
                  'fruit on head', 'glove biting', 'cheek-to-cheek', 'hand on hand', 'crossed arms', 'spread arms',
                  'holding gun', 'holding cup', 'holding food', 'holding book', 'holding wand', 'waving arms',
                  'outstretched arm', 'carrying', 'arm hug', 'holding knife', 'holding', 'holding umbrella',
                  'holding flower', 'holding microphone', 'object hug', 'holding heart']

actions_prompts = ['yokozuwari', 'ahirusuwari', 'indian style', 'kneeling', 'arched back', 'lap pillow', 'paw pose',
                   'one knee', 'fetal position', 'on back', ' on stomach', 'sitting', 'hugging own legs',
                   'upright straddle', 'standing', 'squatting', 'crucifixion', 'leg lock', 'all fours',
                   'hand on headphones', 'ghost pose', 'turning around', 'head tilt', 'leaning forward'
                   ]
person_prompts = [
    ['female', 'male', 'girl', 'boy', 'shota', 'loli', 'bishoujo', 'bishounen', 'gyaru', 'ojousama', 'chibi', 'fat man',
     'crossdressing', 'angel', 'devil', 'minigirl', 'no_humans', 'mesugaki', 'monster', 'elder', 'princess',
     'rich man', 'beggar', 'titans', 'dwarf', 'clown', 'slave', 'yukiwo', 'sheik', 'queen', 'goddess', 'prince',
     'bride', 'bridegroom', 'muscle man', 'idol', 'bunny girl', 'monster girl', 'fox girl', 'wolf girl',
     'cat girl', 'marionette', 'nendoroid'],
    ['solo', 'multiple girls', 'twins', 'triplets', 'brother and sister']
]

career_prompts = ['lifeguard', 'boxer', 'scientist', 'athletes', 'office lady', 'monk', 'crobat', 'nun', 'nurse',
                  'stewardess',
                  'student', 'waitress', 'teacher', 'racer', 'police', 'soldier', 'cheerleader', 'actor', 'actress',
                  'spy', 'agent',
                  'assassin', 'poet', 'samurai', 'dancing girl', 'motorcyclist', 'hacker', 'magician', 'detective',
                  'doll', 'maid', 'pilot',
                  'diver', 'bar censor', 'missionary', 'firefighter', 'goalkeeper', 'chef', 'astronaut', 'cashier',
                  'mailman', 'barista',
                  'the hermit', 'makihitsuji']
anime_characters_prompts = ['pokemon', 'teddy bear', 'mario', 'pikachu', 'neon genesis evangelion', 'hatsune miku',
                            'harry potter',
                            'doraemon', 'saint seiya', 'gojou satoru', 'avengers', 'mazinger', 'captain america',
                            'crayon shin-chan',
                            'slam dunk', 'sun wukong', 'witch', 'ninja', 'vampire', 'knight', 'magical_girl', 'orc',
                            'druid',
                            'elf', 'fairy',
                            'furry', 'mermaid', 'kamen rider', 'magister', 'spider-man', ' santa alter']
facial_features_prompts = [
    ['thick eyebrows', 'cocked eyebrow', 'short eyebrows', 'v-shaped eyebrows'],
    ['empty eyes', 'wide eyes', 'one eye closed', 'half-closed eyes', 'gradient_eyes', 'aqua eyes', 'rolling eyes',
     'cross-eyed', 'slit pupils', 'bloodshot eyes', 'glowing eyes', 'tsurime', 'tareme', 'devil eyes',
     'constricted pupils', 'devil pupils', 'snake pupils', 'pupils sparkling', 'flower-shaped pupils',
     'heart-shaped pupils', 'heterochromia', 'color contact lenses', 'longeyelashes', 'colored eyelashes',
     'mole under eye'],
    ['chestnut mouth', 'thick lips', 'puffy lips', 'lipstick', 'heart-shaped mouth', 'pout', 'open mouth',
     'closed mouth', 'shark mouth', ':p', 'parted lips', 'mole under mouth', ':3'],
...
expression_prompts = ['expressionless', 'turn pale', 'blush stickers', 'blush', 'blank stare', 'anger vein',
                      ...
                      'false smile', 'seductive smile', 'crazy smile', 'evil smile', 'smirk', 'seductive smile',
                      'grin', 'laughing', ':d'
                      ]
hair_prompts = [
    ...
    ['white hair', 'blonde hair', 'silver hair', 'grey hair', 'brown hair', 'black hair', 'purple hair', 'red hair',
     'blue hair', 'green hair', 'pink hair', 'orange hair', 'streaked hair', 'multicolored hair', 'rainbow-like hair'],
    ...
    ['short ponytail', 'side ponytail', 'front ponytail', 'split ponytail', 'low twintails', 'short twintails',
     'side braid', 'braid', 'twin braids', 'ponytail', 'braided ponytail', 'french braid', 'twists', 'high ponytail'],
    ['tied hair', 'single side bun', 'curly hair', 'straight hair', 'wavy hair', 'bob hair', 'heart ahoge',
     'slicked-back', 'Reggae hair', 'pompadour', 'Mohawk', 'bowl cut', 'ahoge', 'antenna hair',
     'drill hair', 'hair wings', 'disheveled hair', 'messy hair', 'chignon', 'braided bun',
     'hime_cut', ' bob cut', 'spiked hair', 'updo', 'pixie cut', 'dreadlocks', 'afro', 'bald', 'double bun',
     'buzz cut', 'big hair', 'shiny hair', 'glowing hair', 'hair between eyes', 'hair behind ear']
]
decoration_prompts = [
    ['hair ribbon', 'head scarf', 'animal hood', 'hair bow', 'crescent hair ornament', 'lolita hairband',
     'feather hair ornament', 'hair flower', 'hair bun', 'hairclip', 'hair scrunchie', 'hair rings', 'hair ornament',
     'hair stick', 'heart hair ornament'],
    ['bracelet', 'choker', 'metal collar', 'ring', 'wristband', 'pendant', 'brooch', 'hoop earrings', 'bangle',
     'stud earrings', 'sunburst', 'pearl bracelet', 'drop earrings', 'puppet rings', 'corsage', 'sapphire brooch',
     'jewelry', 'necklace'],
    ['ribbon', 'ribbon trim', 'lace trim', 'skirt lift', 'gauntlets', 'neckerchief', 'red neckerchief', 'pauldrons',
     'arm strap', 'armlet', 'spaghetti strap', 'Prajna in mask', 'veil', 'bridal veil', 'mini crown', 'tiara',
     'ear covers', 'aviator sunglasses', 'semi-rimless eyewear', 'semi-rimless eyewear', 'sunglasses', 'goggles',
     'eyepatch', 'black blindfold', 'metal thorns', 'halo', 'mouth mask', 'bandaid hair ornament', 'nail polish',
     'doll joints', 'cybernetic prosthesis', 'mechanical legs', 'beach towel,poncho', 'make up']
]
clothes_prompts = [
    ['sleeves_past_fingers', 'tank top', 'white shirt', 'sailor shirt', 'T-shirt', 'sweater', 'summer dress', 'hoodie',
     'fur trimmed colla', 'hooded cloak', 'jacket', 'leather jacket', 'safari jacket', 'hood', 'denim jacket',
     'turtleneck jacket', 'firefighter jacket', 'see-through jacket', 'trench coat', 'lab coat', 'Down Jackets',
     'body armor', 'flak jacket', 'overcoat', 'duffel coat'],
    ['denim shorts', 'pleated skirt', 'short shorts', 'pencil skirt', 'leather skirt', 'black leggings',
     'skirt under kimono']
]
clothes_prompts2 = ['transparent clothes', 'tailcoat', 'Victoria black maid dress', 'sailor suit', 'school uniform',
                    'bussiness suit', 'suit', 'military uniform', 'lucency full dress', 'hanfu', 'cheongsam',
                    'japanses clothes, sportswear', 'dungarees', 'wedding dress', 'silvercleavage dress', 'robe',
                    'apron', 'fast food uniform', 'JK', 'gym_uniform', 'miko attire', 'SWAT uniform',
                    'sleeveless dress,raincoat', 'mech suit', 'wizard robe', 'assassin-style', 'frills',
                    'lace', 'gothic', 'lolita fashion', 'western', 'wet clothes', 'off_shoulder', 'bare_shoulders',
                    'tartan', 'striped', 'armored skirt', 'armor', 'metal armor', 'berserker armor', 'scarf', 'belt',
                    'cape', 'fur shawl'
                    ]
hat_prompts = ['Baseball cap', 'Beanie', 'Bicorne', 'Boater hat', 'Visor cap', 'Bowler hat', 'Cabbie hat', 'Bucket hat',
               'Fedora', 'Cowboy hat', 'Chef hat', 'Military hat', 'Santa hat', 'Party hat', 'Jester cap', 'Hardhat',
               'Baseball helmet', 'Football helmet', 'animal helmet', 'witch hat', 'beret', 'peaked cap', 'Straw hat'
               ]
shoes_prompts = ['bare_legs', 'boots', 'knee boots', 'ankle boots', 'cross-laced_footwear', 'combat boots',
                 'armored boots', 'knee boots', 'rubber boots', 'leather boots', 'snow boots', 'santa boots', 'shoes',
                 'platform footwear', 'pointy footwear', 'sneakers', 'ballet slippers', 'roller skates', 'ice skates',
                 'spiked shoes', 'high heels', 'mary janes', 'loafers', 'uwabaki', 'sandals', 'geta', 'slippers',
                 'flip-flops']
socks_prompts = ['no socks', 'socks', 'tabi', 'stockings', 'christmas stocking', 'leg warmers', 'frilled socks',
                 'ribbon-trimmed legwear', ' shiny legwear', 'frilled thighhighs', 'thighhighs', 'fishnet stockings',
                 'loose socks', 'leggings', 'lace legwear', 'ribbed legwear', ' wet pantyhose', 'plaid legwear',
                 'see-through legwear', 'pantyhose', 'torn pantyhose', 'single leg pantyhose', 'frilled pantyhose',
                 'studded garter belt', 'sock dangle', 'thigh strap', 'leg_garter', 'bandaged leg']

gesture_prompt = ['shushing', 'thumbs up', 'arms behind head', 'arms behind back', 'hand in pocket', 'hands in pocket',
                  'interlocked fingers', 'victory pose', 'hand on floor', 'hand on forehead', 'hand on own stomach',
                  'arm over shoulder', "hand on another's leg", "hand on another's waist", 'own hands clasped',
                  'wide open arms', 'hand to mouth', 'finger gun', 'cat pose']
sight_prompts = ['looking afar', 'looking at mirror', 'looking at phone', 'looking away', 'visible through hair',
                 'looking over glasses', 'look at viewer', 'close to viewer', 'dynamic angle', 'dramatic angle',
                 'stare', 'looking up', 'looking down', 'looking away', 'looking to the side']
environment_prompts = [
    ['in spring', 'in summer', 'in autumn', 'in winter', 'dusk', 'night', '(autumn maple forest:1.3)',
     '(very few fallen leaves), (path)', 'day'],
    ['sun', 'sunset', 'moon', 'full_moon', 'stars', 'sky', 'cloudy', 'rain', 'snow', 'ice', 'snowflakes', 'lighting',
    ...
    ['new year', 'year of the rabbit', 'valentine', 'lantern festival', 'summer festival', 'tanabata',
     'mid-autumn festival', 'halloween', 'christmas', 'explosion', 'water vapor', 'fireworks', 'ceiling window',
