baidu = {
    'voice_role': [
        '度小美(普通)', '度小宇(普通)', '度逍遥(普通)', '度丫丫(普通)',
        '度逍遥(精品)', '度小鹿(精品)', '度博文(精品)', '度小童(精品)', '度小萌(精品)', '度米朵(精品)', '度小娇(精品)'
    ],
    'role_number': [0, 1, 3, 4, 5003, 5118, 106, 110, 111, 103, 5],
    'aue': ['mp3', 'mp3-16k', 'mp3-48k', 'pcm-16k', 'pcm-8k', 'wav'],
    'aue_num': [3, 4, 5, 6],
...
ali = {
    'voice_role': [
        ...
        '艾诚(标准男声-通用场景)', '艾达(标准男声-通用场景)', '知媛(普通话女声-通用场景)', '知柜(普通话女声-通用场景)', '知雅(普通话女声-通用场景)',
        '知悦(普通话女声-通用场景)', '知硕(普通话男声-通用场景)', '知达(普通话男声-通用场景)', '知莎(普通话女声-通用场景)', '思悦(温柔女声-客服场景)',
        '艾雅(严厉女声-客服场景)', '艾夏(亲和女声-客服场景)', '艾美(甜美女声-客服场景)', '艾雨(自然女声-客服场景)', '艾悦(温柔女声-客服场景)',
        '艾婧(严厉女声-客服场景)', '小美(甜美女声-客服场景)', '艾硕(自然男声-客服场景)', '艾娜(浙普女声-客服场景)', '伊娜(浙普女声-客服场景)',
        '思婧(严厉女声-客服场景)', '思彤(儿童音-童声场景)', '杰力豆(治愈童声-童声场景)', '小北(萝莉女声-童声场景)', '艾彤(儿童音-童声场景)',
        '艾薇(萝莉女声-童声场景)', '艾宝(萝莉女声-童声场景)', 'Harry(英音男声-英文场景)', 'ava(美语女声-英文场景)', 'Abby(美音女声-英文场景)',
        'Andy(美音男声-英文场景)', 'Eric(英音男声-英文场景)', 'Emily(英音女声-英文场景)', 'Luna(英音女声-英文场景)', 'Luca(英音男声-英文场景)',
        'Wendy(英音女声-英文场景)', 'William(英音男声-英文场景)', 'Olivia(英音女声-英文场景)', 'Annie(美语女声-英文场景)',
        'Lydia(英中双语女声-英文场景)', '智香(日语女声-日文场景)', '智也(日语男声-日文场景)', '姗姗(粤语女声-方言场景)', '大虎(东北话男声-方言场景)',
        '翠姐(东北话女声-方言场景)', '小泽(湖南重口音男声-方言场景)', '小玥(四川话女声-方言场景)', '青青(台湾话女声-方言场景)',
        '佳佳(粤语女声-方言场景)', 'Kelly(香港粤语女声-方言场景)', '桃子(粤语女声-方言场景)', '艾侃(天津话男声-方言场景)',
        '马树(儿童剧男声-通用场景)', '悦儿(儿童剧女声-通用场景)', '小仙(亲切女声-直播场景)', '知飞(激昂解说-超高清场景)', '知伦(悬疑解说-超高清场景)',
        '猫小美(活力女声-直播场景)', '艾飞(激昂解说-直播场景)', '亚群(卖场广播-直播场景)', '巧薇(卖场广播-直播场景)', '艾伦(悬疑解说-直播场景)',
        '知猫(普通话女声-直播场景)', '老铁(东北老铁-直播场景)', '老妹(吆喝女声-直播场景)', 'Tala(菲律宾语女声-菲律宾语场景)',
        'Tien(越南语女声-越南语场景)', 'Becca(美语客服女声-美式英语)', 'Kyong(韩语女声-韩语场景)', 'masha(俄语女声-俄语场景)',
    ...
    'voice_code': [
        ...
        'william', 'olivia', 'annie', 'lydia', 'zhixiang', 'zhiye', 'shanshan', 'dahu', 'cuijie', 'xiaoze', 'xiaoyue', 'qingqing', 'jiajia', 'kelly',
        'taozi', 'aikan', 'mashu', 'yuer', 'xiaoxian', 'zhifei', 'zhilun', 'maoxiaomei', 'aifei', 'yaqun', 'qiaowei', 'ailun', 'zhimao', 'laotie',
        'laomei', 'tala', 'tien', 'becca', 'kyong', 'mesha', 'farah', 'indah', 'camila', 'perla'
    ],
    'emotion_category': {
        'zhimiao_emo_en': [
            'neutral', 'serious', 'sad', 'disgust', 'jealousy', 'embarrassed', 'happy', 'fear', 'surprise', 'frustrated',
        ...
        'zhimiao_emo_zh': ['中性', '严肃', '悲伤', '厌恶', '嫉妒', '尴尬', '开心', '害怕', '惊讶', '沮丧', '深情', '温柔', '生气', '播报', '客服',
                           '小说', '直播'],
...
azure = {
    ...
    'emotion_category': {
        'Xiaoxiao': {
            'styles_en': ['default', 'assistant', 'chat', 'customerservice', 'newscast', 'affectionate', 'angry', 'calm', 'cheerful', 'disgruntled',
                          'fearful', 'gentle', 'lyrical', 'sad', 'serious', 'poetry-reading', 'friendly'],
            'styles_zh': ['默认', '助理', '闲聊', '客服', '新闻广播', '撒娇', '发怒', '平静', '愉快', '不满', '担心', '温和',
                          '抒情', '悲哀', '严厉', '诗歌阅读', '友爱']},
        'Yunxi': {
            'styles_en': ['default', 'narration-relaxed', 'embarrassed', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed',
                          'chat',
                          'assistant', 'newscast'],
            'styles_zh': ['默认', '叙述放松', '尴尬', '担心', '愉快', '不满', '严厉', '发怒', '悲哀', '沮丧', '闲聊', '助理',
                          '新闻广播'],
        ...
        'Xiaoyi': {
            'styles_en': ['default', 'angry', 'disgruntled', 'affectionate', 'cheerful', 'fearful', 'sad', 'embarrassed', 'serious', 'gentle'],
        ...
        'Xiaohan': {
            'styles_en': ['default', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'gentle', 'affectionate',
                          'embarrassed'],
        ...
        'Xiaomeng': {
            ...
            'styles_zh': ['默认', '闲聊']},
        'Xiaomo': {
            'styles_en': ['default', 'embarrassed', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed',
                          'affectionate', 'gentle', 'envious'],
            'styles_zh': ['默认', '尴尬', '平静', '担心', '愉快', '不满', '严厉', '发怒', '悲哀', '沮丧', '撒娇', '温和', '嫉妒'],
            'roles_en': ['default', 'YoungAdultFemale', 'YoungAdultMale', 'OlderAdultFemale', 'OlderAdultMale', 'SeniorFemale', 'SeniorMale', 'Girl',
                         'Boy'],
        ...
        'Xiaoshuang': {
            ...
            'styles_zh': ['默认', '闲聊']},
        'Xiaoxuan': {
            'styles_en': ['default', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'gentle', 'depressed'],
            'styles_zh': ['默认', '平静', '担心', '愉快', '不满', '严厉', '发怒', '温和', '沮丧'],
            'roles_en': ['default', 'YoungAdultFemale', 'YoungAdultMale', 'OlderAdultFemale', 'OlderAdultMale', 'SeniorFemale',
                         'SeniorMale', 'Girl', 'Boy'],
            'roles_zh': ['默认', '年轻女性', '青年男性', '老年人成年女性', '老年人成年男性', '老年女性', '老年男性', '女孩',
                         '男孩']},
        'Xiaozhen': {
        ...
        'Yunye': {
            'styles_en': ['default', 'embarrassed', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad'],
            ...
            'roles_zh': ['默认', '年轻女性', '青年男性', '老年人成年女性', '老年人成年男性', '老年女性', '老年男性', '女孩',
                         '男孩']},
        'Yunze': {
            'styles_en': ['default', 'calm', 'fearful', 'cheerful', 'disgruntled', 'serious', 'angry', 'sad', 'depressed', 'documentary-narration'],
    ...
    'voice_role': [
        ...
        '晓妮(女-中文(中原官话陕西，简体))', '云翔(男-中文(冀鲁官话，简体))', '云希(男-中文(四川话，简体))', '曉曼(女-中文(粤语，繁体))',
